...
import com.zerobase.productapi.repository.ProductInfoRepository;
import com.zerobase.productapi.repository.ProductOrgRepository;
...
public class ProductService {
  ...
  public void persistAndDeleteCacheInfo(RequestProduct requestProduct,
    ...
    productInfo.resetProduct(requestProduct);
    evictSingleCacheValue("product", requestProduct.getOrgCd().name());
  }
