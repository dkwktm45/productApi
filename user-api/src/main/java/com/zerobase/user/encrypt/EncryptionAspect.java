...
import static com.zerobase.domain.type.Crypt.DEENCRYPT;
import static com.zerobase.domain.type.Crypt.ENCRYPT;
...
public class EncryptionAspect {
  ...
  @Pointcut("execution(* com.zerobase.*.service.*.save*(..))")
